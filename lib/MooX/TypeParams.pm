...
sub import {
    ...
    $target->can('_validate_sub') or $modifiers{with}->('MooX::TypeParams::Role');
...
MooX::TypeParams - Validating sub routine parameters via Type::Tiny.
...
the web interface at L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=MooX-TypeParams>.  I will be notified, and then you'll
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=MooX-TypeParams>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/MooX-TypeParams>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/MooX-TypeParams>

=item * Search CPAN

L<http://search.cpan.org/dist/MooX-TypeParams/>
